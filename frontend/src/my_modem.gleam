...
@external(javascript, "./my_modem.ffi.mjs", "do_init")
...
@external(javascript, "./my_modem.ffi.mjs", "do_push")
...
@external(javascript, "./my_modem.ffi.mjs", "do_replace")
...
@external(javascript, "./my_modem.ffi.mjs", "do_load")
...
@external(javascript, "./my_modem.ffi.mjs", "do_forward")
...
@external(javascript, "./my_modem.ffi.mjs", "do_back")
